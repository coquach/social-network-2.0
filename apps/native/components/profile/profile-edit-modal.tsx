          ...
          <View className="items-center">
            ...
            <View className="mt-2">
              {avatarPicker.selectedImage ? (
                ...
                >
                  <Text className="text-sm font-medium text-app-fg dark:text-app-fg-dark">
                    Xóa ảnh
                  </Text>
                </TouchableOpacity>
              ) : null}
                ...
                return (
                  <Pressable
                    ...
                    className={`rounded-full border px-3 py-1.5 ${
                      isSelected
                        ? 'border-sky-500 bg-sky-500/10 dark:border-cyan-400 dark:bg-cyan-400/20'
                  ...
                  >
                    <Text
                      className={`text-sm ${
                        isSelected
                          ? 'font-bold text-sky-500 dark:text-cyan-400'
              ...
              {interests
                ...
                .map((interest) => (
                  <Pressable
                    key={`custom-${interest}`}
                    onPress={() => toggleInterest(interest)}
                    className="rounded-full border border-sky-500 bg-sky-500/10 px-3 py-1.5 dark:border-cyan-400 dark:bg-cyan-400/20"
                  >
                    <Text className="text-sm font-bold text-sky-500 dark:text-cyan-400">
                      {interest} ✕
                    </Text>
                  </Pressable>
                ))}
