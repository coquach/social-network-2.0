 ...
 * - semiStatic: Semi-static data (group details, settings)
...
/**
 * Common configurations for social network features
 */
export const socialConfigs = {
  feed: createQueryConfig('frequent'),
  posts: createQueryConfig('standard'),
  comments: createQueryConfig('standard'),
  notifications: createQueryConfig('realtime'),
  messages: createQueryConfig('frequent'),
  userProfile: createQueryConfig('semiStatic'),
  groupDetails: createQueryConfig('semiStatic'),
  friendsList: createQueryConfig('standard'),
} as const;
